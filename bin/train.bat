...
@REM set INPUT_IMG_DIR="D:\School Stuff\CSCI 199.1\chapter 3\pyunet\data\train_images"
@REM set MASKED_IMG_DIR="D:\School Stuff\CSCI 199.1\chapter 3\pyunet\data\train_masks"
