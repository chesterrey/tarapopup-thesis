...
from double_depthwise_sep_conv import DoubleDepthwiseSepConv
...
class UEnc(nn.Module):
    def __init__(
        ...
        self.downs.append(DoubleDepthwiseSepConv(64, 128))
        self.downs.append(DoubleDepthwiseSepConv(128, 256))
        self.downs.append(DoubleDepthwiseSepConv(256, 512))

        self.bottleneck = DoubleDepthwiseSepConv(512, 512 * 2)
